...
var _refreshQueue, _adapter, _useNonce, _callbackStorage, _logInfo, _logWarn, _loginIframe, _config, _loadAdapter, loadAdapter_fn, _loadDefaultAdapter, loadDefaultAdapter_fn, _loadCordovaAdapter, loadCordovaAdapter_fn, _loadCordovaNativeAdapter, loadCordovaNativeAdapter_fn, _loadConfig, loadConfig_fn, _setupEndpoints, setupEndpoints_fn, _loadOidcConfig, loadOidcConfig_fn, _setupOidcEndpoints, setupOidcEndpoints_fn, _check3pCookiesSupported, check3pCookiesSupported_fn, _processInit, processInit_fn, _setupCheckLoginIframe, setupCheckLoginIframe_fn, _checkLoginIframe, checkLoginIframe_fn, _checkSsoSilently, checkSsoSilently_fn, _parseCallback, parseCallback_fn, _parseCallbackUrl, parseCallbackUrl_fn, _parseCallbackParams, parseCallbackParams_fn, _processCallback, processCallback_fn, _scheduleCheckIframe, scheduleCheckIframe_fn, _setToken, setToken_fn, _getRealmUrl, getRealmUrl_fn, _createLogger, createLogger_fn;
var Keycloak = class {
  /**
  ...
  constructor(config) {
     ...
     */
    __privateAdd(this, _loadAdapter);
    /**
     * @returns {KeycloakAdapter}
     */
    __privateAdd(this, _loadDefaultAdapter);
    /**
     * @returns {KeycloakAdapter}
     */
    __privateAdd(this, _loadCordovaAdapter);
    /**
     * @returns {KeycloakAdapter}
     */
    __privateAdd(this, _loadCordovaNativeAdapter);
    /**
     ...
     * @returns {void}
     */
    __privateAdd(this, _setupEndpoints);
    /**
     * @param {string | OpenIdProviderMetadata} oidcProvider
     * @returns {Promise<void>}
     */
    __privateAdd(this, _loadOidcConfig);
    /**
     * @param {OpenIdProviderMetadata} config
     * @returns {void}
     */
    __privateAdd(this, _setupOidcEndpoints);
    /**
     * @returns {Promise<void>}
     */
    __privateAdd(this, _check3pCookiesSupported);
    /**
     * @param {KeycloakInitOptions} initOptions
     * @returns {Promise<void>}
     */
    __privateAdd(this, _processInit);
    /**
     * @returns {Promise<void>}
     */
    __privateAdd(this, _setupCheckLoginIframe);
    /**
     * @returns {Promise<boolean | undefined>}
     */
    __privateAdd(this, _checkLoginIframe);
    /**
     * @returns {Promise<void>}
     */
    __privateAdd(this, _checkSsoSilently);
    /**
     * @param {string} url
     */
    __privateAdd(this, _parseCallback);
    /**
     * @param {string} urlString
     */
    __privateAdd(this, _parseCallbackUrl);
    /**
     ...
     */
    __privateAdd(this, _parseCallbackParams);
    __privateAdd(this, _processCallback);
    __privateAdd(this, _scheduleCheckIframe);
    /**
     * @param {string} [token]
     ...
     */
    __privateAdd(this, _setToken);
    /**
     * @returns {string=}
     */
    __privateAdd(this, _getRealmUrl);
    /**
     * @param {Function} fn
     * @returns {(message: string) => void}
     */
    __privateAdd(this, _createLogger);
    ...
    __privateAdd(this, _callbackStorage, void 0);
    __privateAdd(this, _logInfo, __privateMethod(this, _createLogger, createLogger_fn).call(this, console.info));
    __privateAdd(this, _logWarn, __privateMethod(this, _createLogger, createLogger_fn).call(this, console.warn));
    /** @type {LoginIframe} */
    ...
    __publicField(this, "init", async (initOptions = {}) => {
      ...
      if (typeof initOptions.adapter === "string" && adapters.includes(initOptions.adapter)) {
        __privateSet(this, _adapter, __privateMethod(this, _loadAdapter, loadAdapter_fn).call(this, initOptions.adapter));
      } else if (typeof initOptions.adapter === "object") {
        __privateSet(this, _adapter, initOptions.adapter);
      } else if ("Cordova" in window || "cordova" in window) {
        __privateSet(this, _adapter, __privateMethod(this, _loadAdapter, loadAdapter_fn).call(this, "cordova"));
      } else {
        __privateSet(this, _adapter, __privateMethod(this, _loadAdapter, loadAdapter_fn).call(this, "default"));
      }
      ...
      await __privateMethod(this, _loadConfig, loadConfig_fn).call(this);
      await __privateMethod(this, _check3pCookiesSupported, check3pCookiesSupported_fn).call(this);
      await __privateMethod(this, _processInit, processInit_fn).call(this, initOptions);
    ...
    __publicField(this, "createAccountUrl", (options) => {
      const url = __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this);
      if (!url) {
    ...
    __publicField(this, "loadUserProfile", async () => {
      const realmUrl = __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this);
      if (!realmUrl) {
    ...
    __publicField(this, "updateToken", async (minValidity) => {
      ...
      if (__privateGet(this, _loginIframe).enable) {
        await __privateMethod(this, _checkLoginIframe, checkLoginIframe_fn).call(this);
      }
      ...
      if (__privateGet(this, _refreshQueue).length === 1) {
        ...
        try {
          ...
          __privateMethod(this, _setToken, setToken_fn).call(this, response.access_token, response.refresh_token, response.id_token, timeLocal);
    ...
    __publicField(this, "clearToken", () => {
      var _a;
      if (this.token) {
        __privateMethod(this, _setToken, setToken_fn).call(this);
...
_config = new WeakMap();
_loadAdapter = new WeakSet();
loadAdapter_fn = function(type) {
  if (type === "default") {
    return __privateMethod(this, _loadDefaultAdapter, loadDefaultAdapter_fn).call(this);
  }
  if (type === "cordova") {
    __privateGet(this, _loginIframe).enable = false;
    return __privateMethod(this, _loadCordovaAdapter, loadCordovaAdapter_fn).call(this);
  }
  if (type === "cordova-native") {
    __privateGet(this, _loginIframe).enable = false;
    return __privateMethod(this, _loadCordovaNativeAdapter, loadCordovaNativeAdapter_fn).call(this);
  }
  throw new Error("invalid adapter type: " + type);
};
_loadDefaultAdapter = new WeakSet();
...
_loadCordovaAdapter = new WeakSet();
      ...
      return await new Promise((resolve, reject) => {
        ref.addEventListener("loadstart", async (event) => {
          if (event.url.indexOf(getCordovaRedirectUri()) === 0) {
            const callback = __privateMethod(this, _parseCallback, parseCallback_fn).call(this, event.url);
            try {
              await __privateMethod(this, _processCallback, processCallback_fn).call(this, callback);
              resolve();
            } catch (error) {
              reject(error);
            }
    ...
    register: async (options) => {
      ...
      const promise = new Promise((resolve, reject) => {
        ref.addEventListener("loadstart", async (event) => {
          if (event.url.indexOf(getCordovaRedirectUri()) === 0) {
            ref.close();
            const oauth = __privateMethod(this, _parseCallback, parseCallback_fn).call(this, event.url);
            try {
              await __privateMethod(this, _processCallback, processCallback_fn).call(this, oauth);
              resolve();
            } catch (error) {
              reject(error);
            }
...
_loadCordovaNativeAdapter = new WeakSet();
...
loadConfig_fn = async function() {
  if (typeof __privateGet(this, _config) === "string") {
    ...
    __privateMethod(this, _setupEndpoints, setupEndpoints_fn).call(this);
  } else {
    this.clientId = __privateGet(this, _config).clientId;
    if ("oidcProvider" in __privateGet(this, _config)) {
      await __privateMethod(this, _loadOidcConfig, loadOidcConfig_fn).call(this, __privateGet(this, _config).oidcProvider);
    } else {
...
_setupEndpoints = new WeakSet();
setupEndpoints_fn = function() {
  this.endpoints = {
    authorize: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/auth";
    },
    token: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/token";
    },
    logout: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/logout";
    },
    checkSessionIframe: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/login-status-iframe.html";
    },
    thirdPartyCookiesIframe: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/3p-cookies/step1.html";
    },
    register: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/registrations";
    },
    userinfo: () => {
      return __privateMethod(this, _getRealmUrl, getRealmUrl_fn).call(this) + "/protocol/openid-connect/userinfo";
    }
  };
};
_loadOidcConfig = new WeakSet();
loadOidcConfig_fn = async function(oidcProvider) {
  if (typeof oidcProvider === "string") {
    ...
    __privateMethod(this, _setupOidcEndpoints, setupOidcEndpoints_fn).call(this, openIdConfig);
  } else {
    __privateMethod(this, _setupOidcEndpoints, setupOidcEndpoints_fn).call(this, oidcProvider);
  }
};
_setupOidcEndpoints = new WeakSet();
...
_check3pCookiesSupported = new WeakSet();
...
_processInit = new WeakSet();
processInit_fn = async function(initOptions) {
  var _a, _b, _c;
  const callback = __privateMethod(this, _parseCallback, parseCallback_fn).call(this, window.location.href);
  if (callback == null ? void 0 : callback.newUrl) {
    window.history.replaceState(window.history.state, "", callback.newUrl);
  }
  if (callback && callback.valid) {
    await __privateMethod(this, _setupCheckLoginIframe, setupCheckLoginIframe_fn).call(this);
    await __privateMethod(this, _processCallback, processCallback_fn).call(this, callback);
    return;
  }
  ...
  const onLoad = async () => {
    switch (initOptions.onLoad) {
      case "check-sso":
        if (__privateGet(this, _loginIframe).enable) {
          await __privateMethod(this, _setupCheckLoginIframe, setupCheckLoginIframe_fn).call(this);
          const unchanged = await __privateMethod(this, _checkLoginIframe, checkLoginIframe_fn).call(this);
          if (!unchanged) {
            this.silentCheckSsoRedirectUri ? await __privateMethod(this, _checkSsoSilently, checkSsoSilently_fn).call(this) : await doLogin(false);
          }
        } else {
          this.silentCheckSsoRedirectUri ? await __privateMethod(this, _checkSsoSilently, checkSsoSilently_fn).call(this) : await doLogin(false);
        }
  ...
  if (initOptions.token && initOptions.refreshToken) {
    __privateMethod(this, _setToken, setToken_fn).call(this, initOptions.token, initOptions.refreshToken, initOptions.idToken);
    if (__privateGet(this, _loginIframe).enable) {
      await __privateMethod(this, _setupCheckLoginIframe, setupCheckLoginIframe_fn).call(this);
      const unchanged = await __privateMethod(this, _checkLoginIframe, checkLoginIframe_fn).call(this);
      if (unchanged) {
        (_a = this.onAuthSuccess) == null ? void 0 : _a.call(this);
        __privateMethod(this, _scheduleCheckIframe, scheduleCheckIframe_fn).call(this);
      }
    } else {
      try {
...
_setupCheckLoginIframe = new WeakSet();
...
checkSsoSilently_fn = async function() {
  ...
  return await new Promise((resolve, reject) => {
    const messageCallback = async (event) => {
      ...
      const oauth = __privateMethod(this, _parseCallback, parseCallback_fn).call(this, event.data);
      try {
        await __privateMethod(this, _processCallback, processCallback_fn).call(this, oauth);
        resolve();
      } catch (error) {
...
_parseCallback = new WeakSet();
parseCallback_fn = function(url) {
  const oauth = __privateMethod(this, _parseCallbackUrl, parseCallbackUrl_fn).call(this, url);
  if (!oauth) {
    return;
  }
...
parseCallbackUrl_fn = function(urlString) {
  ...
  if (this.responseMode === "query" && url.searchParams.size > 0) {
    parsed = __privateMethod(this, _parseCallbackParams, parseCallbackParams_fn).call(this, url.search, supportedParams);
    url.search = parsed.paramsString;
    newUrl = url.toString();
  } else if (this.responseMode === "fragment" && url.hash.length > 0) {
    parsed = __privateMethod(this, _parseCallbackParams, parseCallbackParams_fn).call(this, url.hash.substring(1), supportedParams);
...
_parseCallbackParams = new WeakSet();
...
processCallback_fn = async function(oauth) {
  ...
  const authSuccess = (accessToken, refreshToken, idToken) => {
    timeLocal = (timeLocal + (/* @__PURE__ */ new Date()).getTime()) / 2;
    __privateMethod(this, _setToken, setToken_fn).call(this, accessToken, refreshToken, idToken, timeLocal);
...
_scheduleCheckIframe = new WeakSet();
scheduleCheckIframe_fn = async function() {
  if (__privateGet(this, _loginIframe).enable && this.token) {
    ...
    const unchanged = await __privateMethod(this, _checkLoginIframe, checkLoginIframe_fn).call(this);
    if (unchanged) {
      await __privateMethod(this, _scheduleCheckIframe, scheduleCheckIframe_fn).call(this);
    }
  }
};
_setToken = new WeakSet();
...
var _clearInvalidValues, clearInvalidValues_fn, _clearAllValues, clearAllValues_fn, _getStoredEntries, getStoredEntries_fn, _parseExpiry, parseExpiry_fn;
var LocalStorage = class {
  constructor() {
    /**
     * Clears all values from local storage that are no longer valid.
     */
    __privateAdd(this, _clearInvalidValues);
    /**
     * Clears all known values from local storage.
     */
    __privateAdd(this, _clearAllValues);
    /**
     * Gets all entries stored in local storage that are known to be managed by this class.
     * @returns {[string, string][]} An array of key-value pairs.
     */
    __privateAdd(this, _getStoredEntries);
    /**
     * Parses the expiry time from a value stored in local storage.
     * @param {string} value
     * @returns {number | null} The expiry time in milliseconds, or `null` if the value is malformed.
     */
    __privateAdd(this, _parseExpiry);
  ...
  get(state) {
    ...
    __privateMethod(this, _clearInvalidValues, clearInvalidValues_fn).call(this);
  ...
  add(state) {
    ...
    try {
      ...
      __privateMethod(this, _clearAllValues, clearAllValues_fn).call(this);
      globalThis.localStorage.setItem(key, value);
    }
  }
};
_clearInvalidValues = new WeakSet();
clearInvalidValues_fn = function() {
  const currentTime = Date.now();
  for (const [key, value] of __privateMethod(this, _getStoredEntries, getStoredEntries_fn).call(this)) {
    const expiry = __privateMethod(this, _parseExpiry, parseExpiry_fn).call(this, value);
    if (expiry === null || expiry < currentTime) {
      globalThis.localStorage.removeItem(key);
    }
  }
};
_clearAllValues = new WeakSet();
clearAllValues_fn = function() {
  for (const [key] of __privateMethod(this, _getStoredEntries, getStoredEntries_fn).call(this)) {
    globalThis.localStorage.removeItem(key);
  }
};
_getStoredEntries = new WeakSet();
getStoredEntries_fn = function() {
  return Object.entries(globalThis.localStorage).filter(([key]) => key.startsWith(STORAGE_KEY_PREFIX));
};
_parseExpiry = new WeakSet();
...
var _getCookie, getCookie_fn, _setCookie, setCookie_fn, _cookieExpiration, cookieExpiration_fn;
var CookieStorage = class {
  constructor() {
     ...
     * @returns {Date}
     */
    __privateAdd(this, _cookieExpiration);
  }
  /**
   * @param {string} [state]
   * @returns {CallbackState | null}
  ...
  get(state) {
    ...
    const value = __privateMethod(this, _getCookie, getCookie_fn).call(this, STORAGE_KEY_PREFIX + state);
    __privateMethod(this, _setCookie, setCookie_fn).call(this, STORAGE_KEY_PREFIX + state, "", __privateMethod(this, _cookieExpiration, cookieExpiration_fn).call(this, -100));
    if (value) {
      return JSON.parse(value);
    }
    return null;
   ...
   */
  add(state) {
    __privateMethod(this, _setCookie, setCookie_fn).call(this, STORAGE_KEY_PREFIX + state.state, JSON.stringify(state), __privateMethod(this, _cookieExpiration, cookieExpiration_fn).call(this, 60));
  }
};
